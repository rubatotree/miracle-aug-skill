...
TOP_FILES = {"SKILL.md", "README.md", "README.zh-CN.md", "LICENSE", ".gitignore", ".gitattributes", "CITATION.bib", "CITATION.cff", "requirements-source.txt", "requirements-deployment.txt"}
